...
query("https://bstevdkjqjzaglayicdg.supabase.co/rest/v1/Class?select=id,name", "Classes");
query("https://bstevdkjqjzaglayicdg.supabase.co/rest/v1/Subject?select=*", "Subjects");
