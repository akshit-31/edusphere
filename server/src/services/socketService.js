  ...
  io.on('connection', (socket) => {
    ...
    socket.on('join_dashboard', (role) => {
      try {
        ...
        logger.error(`Error in join_dashboard for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('join_user', (userId) => {
      try {
        ...
        logger.error(`Error in join_user for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('join_room', async (roomName) => {
      try {
        ...
        logger.error(`Error in join_room for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('join_trip', (data) => {
      try {
        ...
        logger.error(`Error in join_trip for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('leave_room', (roomName) => {
      try {
        ...
        logger.error(`Error in leave_room for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('leave_trip', (data) => {
      try {
        ...
        logger.error(`Error in leave_trip for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('send_message', (data) => {
      try {
        ...
        logger.error(`Error in send_message for socket ${socket.id}: ${err.message}`, { stack: err.stack });
      }
    });
    ...
    socket.on('disconnect', () => {
      try {
        ...
        logger.error(`Error in disconnect handler for socket ${socket.id}: ${err.message}`);
      }
    });
  });
