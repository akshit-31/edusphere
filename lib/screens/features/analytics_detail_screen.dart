            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(child: _statCard('78%', 'Class avg score', '+5% this week', accentBlue)),
                      SizedBox(width: 16.w),
                      Expanded(child: _statCard('12', 'Weak students', 'Need support', accentRose)),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Topic-wise understanding', style: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w800)),
                  ...
                  SizedBox(height: 24.h),
                  Text('Weak students', style: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w800)),
                  ...
                  SizedBox(height: 24.h),
                  _buildPrimaryButton(const Color(0xFFF1F5F9), 'Send remedial plan', isDark: false, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AIGeneratorScreen()))),
