...
class LessonDetailScreen extends StatelessWidget {
  ...
  const LessonDetailScreen({super.key, required this.title, required this.chapter});
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Lesson info', style: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w800)),
                        SizedBox(height: 16.h),
                        _infoRow('Status', 'In Progress', isStatus: true, statusCol: accentBlue),
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 12.w),
                      Expanded(child: _actionBtn('AI tools', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AIGeneratorScreen())))),
                    ],
                  ),
                  SizedBox(height: 12.h),
                  _buildPrimaryButton(darkNavy, 'Mark as complete', onTap: () => Navigator.pop(context)),
                  SizedBox(height: 12.h),
                  _actionBtn('Assign homework', isFull: true, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateHomeworkScreen()))),
  ...
  Widget _infoRow(String label, String val, {bool isStatus = false, Color? statusCol}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if (isStatus)
            Text(val, style: GoogleFonts.inter(fontSize: 14.sp, fontWeight: FontWeight.w800, color: statusCol))
          else
  ...
  Widget _actionBtn(String label, {bool isFull = false, VoidCallback? onTap}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: Text(label, style: GoogleFonts.inter(fontSize: 14.sp, fontWeight: FontWeight.w700, color: const Color(0xFF1E40AF)))),
      ),
    );
  }
