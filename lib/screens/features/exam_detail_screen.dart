...
class _ExamDetailScreenState extends State<ExamDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: TeacherBottomNavBar(activeIndex: 8),
    );
  }
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        icon: Icon(Icons.keyboard_arrow_down, size: 16.sp, color: const Color(0xFF64748B)),
                        style: GoogleFonts.inter(
                          fontSize: 12.sp,
                          fontWeight: FontWeight.w500,
                          color: const Color(0xFF334155),
                        ),
                        items: ['Mathematics', 'Hindi', 'English', 'Science']
                  ...
                  ElevatedButton.icon(
                    onPressed: () {},
                    icon: Icon(Icons.save_outlined, size: 16.sp, color: Colors.white),
                    label: Text(
                      'Save All',
                      style: GoogleFonts.inter(
                        fontSize: 12.sp,
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(flex: 2, child: Text('Theory (70)', style: _headerStyle())),
              Expanded(flex: 2, child: Text('Prac (20)', style: _headerStyle())),
              Expanded(flex: 2, child: Text('Int (10)', style: _headerStyle())),
              Expanded(flex: 2, child: Text('Total', style: _headerStyle())),
        ...
        ..._studentsData.asMap().entries.map((entry) {
          final e = entry.value;
          final isLast = entry.key == _studentsData.length - 1;
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(flex: 2, child: _buildMarkInput(e['theory']!)),
                Expanded(flex: 2, child: _buildMarkInput(e['prac']!)),
                Expanded(flex: 2, child: _buildMarkInput(e['int']!)),
                Expanded(
                  flex: 2,
                  child: Text(
                    e['total']!,
  ...
  Widget _buildMarkInput(String val) {
    return Padding(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          style: GoogleFonts.inter(fontSize: 11.sp, color: const Color(0xFF334155)),
          decoration: const InputDecoration(
            border: InputBorder.none,
            contentPadding: EdgeInsets.only(bottom: 16), // Adjust for center alignment
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.download_outlined, size: 16.sp, color: const Color(0xFF334155)),
              SizedBox(width: 8.w),
              Text(
                '1. Download Template',
                style: GoogleFonts.inter(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.upload_outlined, size: 16.sp, color: const Color(0xFF334155)),
              SizedBox(width: 8.w),
              Text(
                '2. Upload File',
                style: GoogleFonts.inter(
