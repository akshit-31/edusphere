                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Column(children: [
                            Text(e.value['icon']!, style: TextStyle(fontSize: 24.sp)),
                            SizedBox(height: 4.h),
                            Text(e.value['label']!, style: GoogleFonts.inter(fontSize: 12.sp, fontWeight: FontWeight.w800, color: _type == e.key ? AppColors.teacherPrimary : AppColors.textMedium)),
                          ]),
                        ),
                      ),
                    )).toList(),
                    ...
                    child: AnimatedContainer(
                      ...
                      child: _attachedFile == null 
                        ? Column(children: [
                            ...
                            Text('Tap to select file', style: GoogleFonts.inter(fontWeight: FontWeight.w700, color: AppColors.textDark, fontSize: 15.sp)),
                            SizedBox(height: 4.h),
                            Text('PDF, MP4, PNG up to 100MB', style: GoogleFonts.inter(fontSize: 12.sp, color: AppColors.textLight)),
                          ])
                        : Row(children: [
                            Container(
                              padding: EdgeInsets.all(12.r),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Row(children: [
                                    Text('FILE SELECTED', style: GoogleFonts.inter(fontSize: 10.sp, fontWeight: FontWeight.w800, color: AppColors.teacherPrimary, letterSpacing: 0.5)),
                                    SizedBox(width: 6.w),
          ...
          child: Column(
            ...
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('Visible To', style: GoogleFonts.inter(fontSize: 18.sp, fontWeight: FontWeight.w900, color: AppColors.textDark)),
